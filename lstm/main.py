...
if __name__ == "__main__":
    ...
    parser.add_argument("-te", "--train_embeddings", type=bool, help="Whether to change embedding weights during training", default=True)
    ...
    train_dataset = QuoraQuestionDataset(data.train, use_pretrained_emb=args.use_pretrained, reverse_vocab=embedded_vocab_class, preprocess = args.preprocessing, train=True)
